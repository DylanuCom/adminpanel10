        ...
        <div class="container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">{{ trans('web_trans.admins') }}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('web_trans.admin_list') }}</li>
                        </ol>
                    </div>
                </div>
                <!-- End Page Header -->
                    ...
                    <div class="col-sm-12 col-lg-12 col-xl-12">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body pl-0">
                                <div class="col-12">
                                    <div class="container">
                                        <button class="btn btn-primary" data-toggle="modal" data-target="#modal-create">{{ trans('web_trans.createAdmin') }}</button>
                                        <!-- Create Modal -->
                                        <div class="modal fade" id="modal-create">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">{{ trans('web_trans.createAdmin') }}</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="{{route('admins.store')}}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">{{ trans('web_trans.name') }}</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">{{ trans('web_trans.email') }}</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">{{ trans('web_trans.password') }}</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">{{ trans('web_trans.password_confirnation') }}</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleFormControlSelect1">{{ trans('web_trans.select_role') }}</label>
                                                                <select class="form-control" name="role" id="exampleFormControlSelect1">
                                                                    <option value="0"  selected disabled>{{ trans('web_trans.select_role') }}</option>
                                                                    @foreach($roles as $role)
                                                                        <option value="{{$role->name}}">{{$role->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <button type="submit" class="btn btn-primary">{{ trans('web_trans.submit') }}</button>
                                                        </form>
                                                    </div>
                                                </div>
                                                <!-- /.modal-content -->
                                        ...
                                        <table id="table" class="table table-bordered table-striped text-center mt-3">
                                            <thead>
                                            <tr>
                                                <th>{{ trans('web_trans.profile_image') }}</th>
                                                <th>{{ trans('web_trans.name') }}</th>
                                                <th>{{ trans('web_trans.email') }}</th>
                                                <th>{{ trans('web_trans.role') }}</th>
                                                <th>{{ trans('web_trans.Registered') }}</th>
                                                <th>{{ trans('web_trans.Options') }}</th>
                                            </tr>
                                            </thead>
                                            <tbody >
